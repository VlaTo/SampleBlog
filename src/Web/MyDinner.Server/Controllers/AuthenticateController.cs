...
using SampleBlog.Web.Application.MyDinner.Server.ViewModels;
using SignInCommand = SampleBlog.Web.Application.MyDinner.Server.Core.Features.Commands.SignIn.SignInCommand;
