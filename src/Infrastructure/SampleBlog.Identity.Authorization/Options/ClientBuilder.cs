...
public class ClientBuilder
{
    ...
    readonly IdentityServer.Storage.Models.Client client;
    private bool built;
    ...
    public ClientBuilder()
        : this(new IdentityServer.Storage.Models.Client())
    {
    }
    ...
    public ClientBuilder(IdentityServer.Storage.Models.Client client)
    {
        this.client = client;
    }
    ...
    public IdentityServer.Storage.Models.Client Build()
    {
        if (built)
        {
    ...
    private static IdentityServer.Storage.Models.Client CreateClient(string name)
    {
